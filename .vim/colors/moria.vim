...
if &background == "dark"
    if s:moria_style == "dark"
        ...
        hi CursorColumn ctermbg=DarkGray ctermfg=LightGray guibg=#404040 gui=none
        hi CursorLine ctermbg=DarkGray ctermfg=LightGray guibg=#404040 gui=none
    elseif s:moria_style == "black"
        hi Normal ctermbg=Black ctermfg=LightGray guibg=#000000 guifg=#d0d0d0 gui=none

        hi CursorColumn ctermbg=DarkGray ctermfg=LightGray guibg=#3a3a3a gui=none
        hi CursorLine ctermbg=DarkGray ctermfg=LightGray guibg=#3a3a3a gui=none
    endif
